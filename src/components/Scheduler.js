      ...
      <div className="pageHeaders">
        ...
        <div className="quickAboutMe">
          ...
          <p className="description">
            An app for tennis coaches and players to keep track of and schedule
            their lessons.
            <ul>
              <li>Book lessons</li>
          ...
          <p className="idea">
            ...
            before. I thought that if there was a quick way to write up some
            notes about each lesson right after it happened, and then be able to
            review those notes prior to the next lesson, it would make my job as
            a coach infinitely easier. It would also help create that personal
            connection with my clients, something that was always incredibly
            important to me when I was learning tennis.
          </p>
        </div>
      </div>
    );
